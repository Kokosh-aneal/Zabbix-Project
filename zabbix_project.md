...
Aby dodać hosta do zabbixa trzeba wejść w Configuration->Hosts, następnie musimy wejśc w zakładkę "Create Host"      return
![Create Host](createhost.png) 
 Następnie musimy podać dane naszego hosta.        return
